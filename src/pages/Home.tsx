...
const Home = () => {
  return (
    <div className="w-full overflow-x-hidden bg-homeBackground min-h-screen flex flex-col pt-[150px]">
      <section className={`w-full ${PADDING_CLASSES.page.full} flex-grow flex flex-col justify-center`}></section>
      <div className="text-left flex flex-col gap-[10px] px-5 pt-[100px]">
