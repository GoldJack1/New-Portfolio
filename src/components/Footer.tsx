      ...
      <div className={`w-full ${PADDING_CLASSES.footer.horizontal} relative z-10`}>
        <div className="flex flex-col gap-6 w-full min-w-0">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-4 w-full">
            ...
            <div className="flex gap-[25px] justify-end items-start pt-[17px] h-[46px]">
            ...
            <div className="flex flex-col gap-2" style={{ width: '150px' }}>
              ...
              {footerLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="text-xs text-text-primary hover:text-text-primary transition-colors font-extralight"
                >
                  {link.label}
                </Link>
              ))}
