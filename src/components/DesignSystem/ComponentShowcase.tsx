...
const ComponentShowcase = () => {
  return (
    <section className="mb-16 w-full overflow-x-hidden">
      <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-6 break-words">Components</h2>
      <div className="space-y-8 w-full min-w-0">
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-4">Navigation</h3>
          <div className="bg-gray-100 p-4 rounded-2xl">
            <p className="text-sm text-gray-600 mb-4">Pill navigation header with active/inactive states</p>
