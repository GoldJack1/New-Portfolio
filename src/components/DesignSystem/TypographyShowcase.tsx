  ...
  return (
    <section className="mb-16 w-full overflow-x-hidden">
      ...
      <div className="space-y-6 bg-gray-800 p-6 sm:p-8 rounded-2xl w-full min-w-0">
        ...
        {/* Body Large */}
        <div className="space-y-1">
          <p className="text-base sm:text-lg md:text-xl text-text-primary">Body Large - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>
          <p className="text-sm text-text-primary">
        ...
        {/* Body */}
        <div className="space-y-1">
          <p className="text-sm sm:text-base md:text-lg text-text-primary">Body - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
          <p className="text-sm text-text-primary">
        ...
        {/* Body Small */}
        <div className="space-y-1">
          <p className="text-xs sm:text-sm md:text-base text-text-secondary">Body Small - Secondary text with lower contrast. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          <p className="text-sm text-text-primary">
        ...
        {/* Caption */}
        <div className="space-y-1">
          <p className="text-xs sm:text-xs md:text-sm text-text-tertiary">Caption - Tertiary text with lowest contrast. Used for captions, labels, and metadata.</p>
          <p className="text-sm text-text-primary">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Mobile */}
          <div className="space-y-6 bg-gray-800 p-6 sm:p-8 rounded-2xl w-full min-w-0">
            <h4 className="text-lg font-bold text-text-primary mb-4">Mobile</h4>
            ...
            <div className="space-y-1">
              <h2 className="text-2xl font-bold text-text-primary">Heading 2</h2>
              <p className="text-sm text-text-primary">
                Size: 24px
                <br />
                Line Height: 1.25 • Letter Spacing: -0.01em
            ...
            <div className="space-y-1">
              <h3 className="text-xl font-semibold text-text-primary">Heading 3</h3>
              <p className="text-sm text-text-primary">
                Size: 20px
                <br />
                Line Height: 1.3 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <h4 className="text-lg font-semibold text-text-primary">Heading 4</h4>
              <p className="text-sm text-text-primary">
                Size: 18px
                <br />
                Line Height: 1.35 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-base text-text-primary">Body Large - Lorem ipsum dolor sit amet</p>
              <p className="text-sm text-text-primary">
                Size: 16px
                <br />
                Line Height: 1.5 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-sm text-text-primary">Body - Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              <p className="text-sm text-text-primary">
                Size: 14px
                <br />
                Line Height: 1.6 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-xs text-text-secondary">Body Small - Secondary text with lower contrast</p>
              <p className="text-sm text-text-primary">
                Size: 12px
                <br />
                Line Height: 1.5 • Letter Spacing: 0.01em
          ...
          {/* Tablet */}
          <div className="space-y-6 bg-gray-800 p-6 sm:p-8 rounded-2xl w-full min-w-0">
            <h4 className="text-lg font-bold text-text-primary mb-4">Tablet</h4>
            ...
            <div className="space-y-1">
              <p className="text-lg text-text-primary">Body Large - Lorem ipsum dolor sit amet</p>
              <p className="text-sm text-text-primary">
                Size: 18px
                <br />
                Line Height: 1.5 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-base text-text-primary">Body - Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              <p className="text-sm text-text-primary">
                Size: 16px
                <br />
                Line Height: 1.6 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-sm text-text-secondary">Body Small - Secondary text with lower contrast</p>
              <p className="text-sm text-text-primary">
                Size: 14px
                <br />
                Line Height: 1.5 • Letter Spacing: 0.01em
          ...
          {/* Desktop */}
          <div className="space-y-6 bg-gray-800 p-6 sm:p-8 rounded-2xl w-full min-w-0">
            <h4 className="text-lg font-bold text-text-primary mb-4">Desktop</h4>
            ...
            <div className="space-y-1">
              <h3 className="text-4xl font-semibold text-text-primary">Heading 3</h3>
              <p className="text-sm text-text-primary">
                Size: 36px
                <br />
                Line Height: 1.3 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-xl text-text-primary">Body Large - Lorem ipsum dolor sit amet</p>
              <p className="text-sm text-text-primary">
                Size: 20px
                <br />
                Line Height: 1.5 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-lg text-text-primary">Body - Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              <p className="text-sm text-text-primary">
                Size: 18px
                <br />
                Line Height: 1.6 • Letter Spacing: 0
            ...
            <div className="space-y-1">
              <p className="text-base text-text-secondary">Body Small - Secondary text with lower contrast</p>
              <p className="text-sm text-text-primary">
                Size: 16px
                <br />
                Line Height: 1.5 • Letter Spacing: 0.01em
