const TypographyShowcase = () => {
  return (
    <section className="mb-16 w-full overflow-x-hidden">
      <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-50 mb-6 break-words">Typography</h2>
      
      {/* Font Weights */}
      <div className="mb-8 bg-gray-800 p-6 sm:p-8 rounded-2xl w-full min-w-0">
        <h3 className="text-xl font-semibold text-gray-50 mb-4">Font Weights</h3>
        <div className="space-y-3">
          <div>
            <p className="text-xs text-gray-300 mb-1">Thin (100)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 100 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Extra Light (200)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 200 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Light (300)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 300 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Regular (400)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 400 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Medium (500)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 500 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Semi Bold (600)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 600 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Bold (700)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 700 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Extra Bold (800)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 800 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
          <div>
            <p className="text-xs text-gray-300 mb-1">Black (900)</p>
            <p className="text-2xl text-gray-50" style={{ fontWeight: 900 }}>The quick brown fox jumps over the lazy dog</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6 bg-gray-800 p-6 sm:p-8 rounded-2xl w-full min-w-0">
        <h3 className="text-xl font-bold text-gray-50 mb-4">Typography Scale</h3>
        
        {/* Heading 1 */}
        <div className="space-y-1">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-50">Heading 1</h1>
        ...
        {/* Heading 2 */}
        <div className="space-y-1">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-50">Heading 2</h2>
          <p className="text-sm text-gray-300">
        ...
        {/* Heading 3 */}
        <div className="space-y-1">
          <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-50">Heading 3</h3>
          <p className="text-sm text-gray-300">
        ...
        {/* Heading 4 */}
        <div className="space-y-1">
          <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-gray-50">Heading 4</h4>
          <p className="text-sm text-gray-300">
